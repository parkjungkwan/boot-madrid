...
import kr.scalar.api.item.domain.PhoneDto;
import kr.scalar.api.item.service.HimartService;
import kr.scalar.api.item.service.impl.HimartServiceImpl;
...
public class HimartController extends LambdaUtils {
    ...
    public void phoneMain(Scanner scanner){
        PhoneDto app = new PhoneDto();
        PhoneDto.Phone phone = null;
        PhoneDto.CelPhone celPhone = null;
        PhoneDto.IPhone iPhone = null;
        PhoneDto.GalaxyNote galaxyNote = null;
        while(true){
            ...
            switch (scanner.next()){
                ...
                case "3":
                    ...
                    iPhone.setKind(PhoneDto.IPhone.BRAND);
                ...
                case "4":
                    ...
                    galaxyNote.setKind(PhoneDto.GalaxyNote.BRAND);
